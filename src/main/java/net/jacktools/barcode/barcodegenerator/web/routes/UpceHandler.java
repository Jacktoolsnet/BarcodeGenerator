    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        try {
            ...
            if (null != queryParameter.get("value")) {
                byte[] bytes = Barcode.createByteArray(queryParameter.get("value"), BarcodeFormat.UPC_E, null != queryParameter.get("width") ? Integer.valueOf(queryParameter.get("width")) : Settings.BARCODE_DEFAULT_WIDTH, null != queryParameter.get("height") ? Integer.valueOf(queryParameter.get("height")) : Settings.BARCODE_DEFAULT_HEIGHT);
