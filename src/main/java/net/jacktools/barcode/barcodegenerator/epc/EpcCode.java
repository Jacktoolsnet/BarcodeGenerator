...
public class EpcCode {
    public static final Number MIN_PAYMENT_AMOUNT = 0.01;
    public static final Number MAX_PAYMENT_AMOUNT = 999999999.99;
    ...
    public static String getValue() {
        ...
        stringBuilder.append(SERVICE_TAG)
                ...
                .append(IBAN)
                .append(System.lineSeparator())
                .append(null != CURRENCY ? CURRENCY.toString() : CURRENCY)
